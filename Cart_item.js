   ...
   const apiUrl = 'https://blank-sunglasses.com/products/john.js';
    ...
    fetch(apiUrl)
        ...
        .then(userData => {
            ...
            updateCartIfEmpty(userData);
        })
        .catch(error => {
            console.error('Error:', error);
        });

    function updateCartIfEmpty(userData) {
        const cartStatusElement = document.querySelector("#cart-drawer > p.h5.text-center");
        
        if (cartStatusElement && cartStatusElement.textContent.trim() === "Your cart is empty") {
            //console.log("Cart is empty. Updating cart...");
            ...
            cartStatusElement.parentElement.innerHTML = newElement;
            ...
            console.log("Cart is not empty. No update needed.");
        }
    }
}
Updatecart();
